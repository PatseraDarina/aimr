        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="delete-form" id="delete-form">
                    ...
                    <div class="modal-footer ">
                        <button type="submit" class="btn btn-success" onclick="delete_employee(document.getElementById('employeeId').value, document.getElementById('rowId').value, document.getElementById('departmentId').value)"><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
...
<script>
    ...
    for(var i = 1; i < table.rows.length; i++) {
            table.rows[i].onclick  = function() {
                ...
                document.getElementById("departmentId").value = this.cells[6].innerHTML;
        }
    }
</script>
