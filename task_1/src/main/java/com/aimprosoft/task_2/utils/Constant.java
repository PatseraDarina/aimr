...
public final class Constant {
    ...
    public static final String JDBC_TASK_1 = "jdbc/task_1";
    public static final String UNABLE_TO_INSTANTIATE_DATA_SOURCE = "Unable to instantiate dataSource: ";
    ...
    public static class Message {
        ...
        public static final String UPDATE_SUCCESS = "Record was updated successfully";
    ...
    public static class Hibernate {
        public static final String PERSISTENT_UNIT_NAME = "department";
    }
}
