            ...
            <div class="modal-body">
                <form name="delete-form" id="delete-form">
                    ...
                    <div class="modal-footer ">
                        <button type="submit" class="btn btn-success" onclick="return delete_department(document.getElementById('departmentId').value, document.getElementById('rowId').value)"><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
