...
function update_department(departmentId, name) {
    ...
    function update_employee(employeeId, employeeName, employeeSalary, employeeEmail, employeeDate, departmentName) {
    if (validateForm()) {
            $.ajax({
                url: "employee?employeeName=" + employeeName + "&employeeSalary=" + employeeSalary + "&employeeEmail=" + employeeEmail + "&employeeDate=" + employeeDate + "&departmentName=" + departmentName + "&employeeId=" + employeeId,
                type: "PUT",
                success: function(result) {
                    $("#info").html(result)
                }
